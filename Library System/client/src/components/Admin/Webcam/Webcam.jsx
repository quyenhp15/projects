...
const Webcam = (props) => {
    ...
    const { setOpenCamera, onReceiveImg } = props;
    ...
    async function loadLabeledImages() {
        ...
        // console.log('Image data: ', user.data.faceID);
        // userImage.src = `${user.data.faceID}`;
        ...
        return new faceapi.LabeledFaceDescriptors('', descriptions);
    }
